...
define(function(require) {
    ...
    /*test("projectOnVector", function () {
        ...
        ok(b.copy(a).projectOnVector(normal).equals(new Vector3(1, 0, 0)), "Passed!");

        a.set(0, 1, 0);
        ok(b.copy(a).projectOnVector(normal).equals(new Vector3(0, 0, 0)), "Passed!");
    ...
    test("projectOnPlane", function () {
        ...
        ok(b.copy(a).projectOnPlane(normal).equals(new Vector3(0, 0, 0)), "Passed!");

        a.set(0, 1, 0);
        ok(b.copy(a).projectOnPlane(normal).equals(new Vector3(0, 1, 0)), "Passed!");

        a.set(0, 0, -1);
        ok(b.copy(a).projectOnPlane(normal).equals(new Vector3(0, 0, -1)), "Passed!");
    ...
    test("reflect", function () {
        ...
        ok(b.copy(a).reflect(normal).equals(new Vector3(1, 0, 0)), "Passed!");

        a.set(1, -1, 0);
        ok(b.copy(a).reflect(normal).equals(new Vector3(1, 1, 0)), "Passed!");
    ...
    test("angleTo", function () {
        ...
        ok(Math.abs(x.angleTo(new Vector3(1, 1, 0)) - ( Math.PI / 4 )) < 0.0000001);
    });*/
